...
<script type="text/javascript">
    ...
    function createCode() {
        ...
        if(resQrCodeText.indexOf('error') < 0){
            $("#qrCode").attr('src', '${pageContext.request.contextPath}/servlet/qrCode?keyCode=' + resQrCodeText).removeAttr('hidden');
        }
    }
</script>
<body class="no-skin">
<div class="error-container">
    ...
    <div class="errorcon">
        <label>商户名称：</label>
        <input type="text" name="mchntName" id="mchntName" style="width:320px;"/><br><br>
        <label>省&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;份：</label>
        <select name="province" id="s1" style="width: 315px">
            <option></option>
        </select><br><br>
        <label>城&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;市：</label>
        <select name="city" id="s2" style="width: 315px">
            <option></option>
        </select><br><br>
        ...
        <label>详细地址：</label>
        <input type="text" id="address" name="address" style="width:320px;"/>

        <div style="padding:7px;"><input type="submit" onclick="createCode()"
                                          class="button button-block bg-main text-big input-big" value="生成"></div>
        <img alt="二维码" id="qrCode" hidden="hidden" height="200" width="200" src=""/><br>
